...
function DrawerHeader({
	...
	return (
		<div
			className={cnExt('flex items-center gap-3 border-stroke-soft-200 p-5', className)}
			{...rest}
		>
			{children}
...
function DrawerBody({ className, children, ...rest }: React.HTMLAttributes<HTMLDivElement>) {
	return (
		<div
			className={cnExt('flex-1', className)}
			{...rest}
		>
			{children}
		</div>
...
function DrawerFooter({ className, ...rest }: React.HTMLAttributes<HTMLDivElement>) {
	return (
		<div
			className={cnExt('flex items-center gap-4 border-stroke-soft-200 p-5', className)}
			{...rest}
		/>
	);
}
